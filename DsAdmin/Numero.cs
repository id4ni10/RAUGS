...
namespace DsAdmin
{
    public class Numero
    {
        ...
        public void Incluir(String des_numero_num, ref Int32 cod_numero_num)
        {
            ...
            retorno = _Command.Parameters.Add("@cod_numero_num", SqlDbType.Int);
            retorno.Direction = ParameterDirection.Output;

            neo.ExecutaNonQuery(_Command);
            cod_numero_num = (Int32)_Command.Parameters["cod_numero_num"].Value;
